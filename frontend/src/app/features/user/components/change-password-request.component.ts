...
@Component({
  selector: 'ccnta-change-password-request',
  template: `
   <div class="flex justify-center items-center h-[78vh] text-center">
  <div class="bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-md">
    <h2 class="text-2xl font-bold text-green-500 mb-4">Changing your password</h2>
    <div class="flex flex-col justify-center items-center mb-6 gap-2">
      ...
      <span class="text-green-500">If an account exists for {{authenticatedUser.email}}, you will receive a password reset link shortly.</span>
    </div>
    <a (click)="onSubmit()" class="text-green-500 hover:text-green-600 font-medium bg-green-100 px-4 py-2 rounded-md text-sm">
...
export class ChangePasswordRequestComponent {
  ...
  public onSubmit = ():void =>{
    this._router.navigate(['home/users/profile']);
  }
